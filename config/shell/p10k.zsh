# Generated by Powerlevel10k configuration wizard on 2024-01-10 at 23:27 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # nvm                   # lazy-loaded to avoid paying nvm startup cost in every shell
  ...
  # Use a single static prompt char for all modes (hide vi mode state visually)
  ...
  # vi_mode segment intentionally disabled (prompt_char already handles primary indication)
