...
class DotCliTests(unittest.TestCase):
    ...
    def test_kubuntu_manages_vscode_and_fullscreen_rdp_files(self):
        ...
        self.assertEqual(profile["rdp"]["resolution_width"], 2880)
        self.assertEqual(profile["rdp"]["resolution_height"], 1800)
        ...
        self.assertIn('profile["rdp"]', remmina_launcher)
    ...
    def test_kubuntu_desktop_inherits_workstation_policy_without_laptop_hardware(self):
        ...
        self.assertEqual(profile["rdp"]["resolution_width"], 3840)
        self.assertEqual(profile["rdp"]["resolution_height"], 2160)
        self.assertTrue(profile["features"]["meshcentral_agent"])
        self.assertFalse(profile["features"]["anydesk"])
