...
class DotCliTests(unittest.TestCase):
    ...
    def test_kubuntu_manages_vscode_and_fullscreen_rdp_files(self):
        ...
        self.assertIn('"resolution_mode": "1"', remmina_launcher)
        self.assertNotIn('"resolution_width"', remmina_launcher)
        self.assertNotIn('"resolution_height"', remmina_launcher)
        ...
        self.assertIn('"rdp_desktopScaleFactor": "100"', remmina_preferences)
        self.assertIn('"rdp_deviceScaleFactor": "100"', remmina_preferences)
