...
class DotCliTests(unittest.TestCase):
    ...
    def test_homelab_secrets_are_not_loaded_by_shell_startup(self):
        ...
        self.assertIn('"pinned-certificate"', cli)
        self.assertIn("fetch_truenas_certificate", cli)
        self.assertIn('Type `trust` to accept this certificate', cli)
    ...
    def test_native_plasma_panel_and_application_palette_are_managed(self):
        ...
        self.assertIn("hidecursorEnabled=false", kwin)
        self.assertNotIn("[Effect-hidecursor]", kwin)
