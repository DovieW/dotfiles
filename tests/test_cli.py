...
class DotCliTests(unittest.TestCase):
    ...
    def test_kubuntu_uses_separate_clipboard_and_emoji_tools(self):
        ...
        self.assertIn("config('clipboard_mime_size_limit', 'image/.*:0;application/x-qt-image:0;.*:100M')", copyq)
        ...
        self.assertIn("COPYQ_CLIPBOARD_MIME_SIZE_LIMIT", copyq_installer)
