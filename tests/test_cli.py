...
class DotCliTests(unittest.TestCase):
    ...
    def test_nomachine_is_private_to_the_kubuntu_tailnet(self):
        ...
        client = (ROOT / "scripts/configure-nomachine-client").read_text()
        ...
        self.assertIn("configure-nomachine-client", task)
        ...
        self.assertIn("DEFAULT_FONT", client)
        self.assertIn("HIDPI_THRESHOLD = 1.5", client)
